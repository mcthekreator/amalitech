...
import type { ProcessManyResult } from '../../models';

const processResponse: ProcessManyResult = {
  allResultsValid: true,
  calculationTotalPrice: 1,
  processResults: [
    {
      chainflex: {
        description: {
      ...
      configurationReference: {
        ...
        sccId: 'exampleSingleCableCalculationId',
        validationErrors: [],
      },
...
/**
 * createProcessResponse creates a ProcessManyResult
 *
 * @param override pass any needed overrides for the requested ProcessManyResult
 * @returns ProcessManyResult
 */
export const createProcessResponse = (override?: NestedPartial<ProcessManyResult>): ProcessManyResult => {
  return mergePartially.deep(processResponse, override);
};
